...
#include <fbxfilesdk/fbxfilesdk_nsbegin.h>
    ...
    template <class T> inline EFbxType FbxTypeOf( T const &pItem ) { K_ASSERT_MSG_NOW("Unknown type" ); return eUNIDENTIFIED; }
 	...
 	inline EFbxType FbxTypeOf( fbxByte1 const & )      { return eBYTE1;      }
	inline EFbxType FbxTypeOf( fbxUByte1 const & )     { return eUBYTE1;     }
	inline EFbxType FbxTypeOf( fbxShort1 const & )     { return eSHORT1;     }
	inline EFbxType FbxTypeOf( fbxUShort1 const &)    { return eUSHORT1;    }
	inline EFbxType FbxTypeOf( fbxUInteger1 const & )  { return eUINTEGER1;  }
	inline EFbxType FbxTypeOf( fbxLongLong1 const & )  { return eLONGLONG1;  }
	inline EFbxType FbxTypeOf( fbxULongLong1 const & ) { return eULONGLONG1; }
	inline EFbxType FbxTypeOf( fbxHalfFloat const & )  { return eHALFFLOAT;  }
    inline EFbxType FbxTypeOf( fbxBool1 const & )      { return eBOOL1;      }
    inline EFbxType FbxTypeOf( fbxInteger1 const & )   { return eINTEGER1;   }
    inline EFbxType FbxTypeOf( fbxFloat1 const & )     { return eFLOAT1;     }
    inline EFbxType FbxTypeOf( fbxDouble1 const & )    { return eDOUBLE1;    }
    inline EFbxType FbxTypeOf( fbxDouble2 const & )    { return eDOUBLE2;    }
    inline EFbxType FbxTypeOf( fbxDouble3 const & )    { return eDOUBLE3;    }
    inline EFbxType FbxTypeOf( fbxDouble4 const &)    { return eDOUBLE4;    }
    inline EFbxType FbxTypeOf( fbxDouble44 const &)   { return eDOUBLE44;   }
//  inline EFbxType FbxTypeOf( fbxEnum const &pItem )       { return eENUM;       }
    inline EFbxType FbxTypeOf( fbxString const & )     { return eSTRING;     }
    inline EFbxType FbxTypeOf( fbxTime  const &)      { return eTIME;       }
    inline EFbxType FbxTypeOf( fbxReference const & )  { return eREFERENCE;  }
    inline EFbxType FbxTypeOf( fbxBlob const &)       { return eBLOB;       }
    inline EFbxType FbxTypeOf( fbxDistance const &)    { return eDISTANCE;   }
    inline EFbxType FbxTypeOf( fbxDateTime const &)    { return eDATETIME;   }
	...
	inline EFbxType _FbxTypeOf( fbxByte1 const & )      { return eBYTE1;      }
	inline EFbxType _FbxTypeOf( fbxUByte1 const &)     { return eUBYTE1;     }
	inline EFbxType _FbxTypeOf( fbxShort1 const & )     { return eSHORT1;     }
	inline EFbxType _FbxTypeOf( fbxUShort1 const & )    { return eUSHORT1;    }
	inline EFbxType _FbxTypeOf( fbxUInteger1 const & )  { return eUINTEGER1;  }
	inline EFbxType _FbxTypeOf( fbxLongLong1 const &)  { return eLONGLONG1;  }
	inline EFbxType _FbxTypeOf( fbxULongLong1 const &) { return eULONGLONG1; }
	inline EFbxType _FbxTypeOf( fbxHalfFloat const & )  { return eHALFFLOAT;  }
    inline EFbxType _FbxTypeOf( fbxBool1 const &)      { return eBOOL1;      }
    inline EFbxType _FbxTypeOf( fbxInteger1 const &)   { return eINTEGER1;   }
    inline EFbxType _FbxTypeOf( fbxFloat1 const &)     { return eFLOAT1;     }
    inline EFbxType _FbxTypeOf( fbxDouble1 const &)    { return eDOUBLE1;    }
    inline EFbxType _FbxTypeOf( fbxDouble2 const &)    { return eDOUBLE2;    }
    inline EFbxType _FbxTypeOf( fbxDouble3 const &)    { return eDOUBLE3;    }
    inline EFbxType _FbxTypeOf( fbxDouble4 const & )    { return eDOUBLE4;    }
    inline EFbxType _FbxTypeOf( fbxDouble44 const & )   { return eDOUBLE44;   }
//  inline EFbxType _FbxTypeOf( fbxEnum const &pItem )       { return eENUM;       }
    inline EFbxType _FbxTypeOf( fbxString const & )     { return eSTRING;     }
    inline EFbxType _FbxTypeOf( fbxTime const &)       { return eTIME;       }
    inline EFbxType _FbxTypeOf( fbxReference const &)  { return eREFERENCE;  }
    inline EFbxType _FbxTypeOf( fbxBlob const & )       { return eBLOB;       }
    inline EFbxType _FbxTypeOf( KFbxColor   const &)   { return eDOUBLE4;    }
    inline EFbxType _FbxTypeOf( fbxDistance const &)   { return eDISTANCE;   }
    inline EFbxType _FbxTypeOf( fbxDateTime const & )   { return eDATETIME;   }

    // Additional types
    inline EFbxType FbxTypeOf( KFbxColor    const & )  { return eDOUBLE4; }
...
//  inline bool fbxCopy( fbxEnum &pDst,fbxEnum const &pSrc )            { pDst=pSrc; return true; }
	...
	inline bool fbxCopy( fbxBool1 &,fbxHalfFloat const & )      { return false; }
//  inline bool fbxCopy( fbxBool1 &pDst,fbxBool1 const &pSrc )          { pDst   = (fbxBool1)pSrc; return true; }
    ...
    inline bool fbxCopy( fbxBool1 &,fbxDouble2 const & )        { return false; }
    inline bool fbxCopy( fbxBool1 &,fbxDouble3 const & )        { return false; }
    inline bool fbxCopy( fbxBool1 &,fbxDouble4 const & )        { return false; }
    inline bool fbxCopy( fbxBool1 &,fbxDouble44 const & )       { return false; }
//  inline bool fbxCopy( fbxBool1 &pDst,fbxEnum const &pSrc )           { return false; }
    ...
    inline bool fbxCopy( fbxBool1 &,fbxTime const & )           { return false; }
    inline bool fbxCopy( fbxBool1 &,fbxReference const & )      { return false; }
    inline bool fbxCopy( fbxBool1 &,fbxBlob const & )           { return false; }
    inline bool fbxCopy( fbxBool1 &, fbxDistance const & )      { return false; }
    inline bool fbxCopy( fbxBool1 &, fbxDateTime const & )      { return false; }
	...
	inline bool fbxCopy( fbxByte1 &,fbxShort1 const & )         { return false; }
	inline bool fbxCopy( fbxByte1 &,fbxUShort1 const & )        { return false; }
    inline bool fbxCopy( fbxByte1 &,fbxUInteger1 const & )      { return false; }
	inline bool fbxCopy( fbxByte1 &,fbxLongLong1 const & )      { return false; }
	inline bool fbxCopy( fbxByte1 &,fbxULongLong1 const & )     { return false; }
	inline bool fbxCopy( fbxByte1 &,fbxHalfFloat const &)      { return false; }
    ...
    inline bool fbxCopy( fbxByte1 &,fbxDouble2 const & )		{ return false; }
	inline bool fbxCopy( fbxByte1 &,fbxDouble3 const & )		{ return false; }
    inline bool fbxCopy( fbxByte1 &,fbxDouble4 const & )		{ return false; }
    inline bool fbxCopy( fbxByte1 &,fbxDouble44 const & )       { return false; }
//  inline bool fbxCopy( fbxByte1 &pDst,fbxEnum const &pSrc )           { return false; }
    ...
    inline bool fbxCopy( fbxByte1 &,fbxTime const &)           { return false; }
    inline bool fbxCopy( fbxByte1 &,fbxReference const &)      { return false; }
    inline bool fbxCopy( fbxByte1 &,fbxBlob const & )			{ return false; }
    inline bool fbxCopy( fbxByte1 &,fbxDistance const & )       { return false; }
    inline bool fbxCopy( fbxByte1 &,fbxDateTime const & )       { return false; }
...
//	inline bool fbxCopy( fbxUByte1 &pDst,fbxUByte1 const &pSrc )        { pDst   = (fbxUByte1)pSrc; return true; }
	inline bool fbxCopy( fbxUByte1 &,fbxShort1 const & )        { return false; }
	inline bool fbxCopy( fbxUByte1 &,fbxUShort1 const & )       { return false; }
	inline bool fbxCopy( fbxUByte1 &,fbxUInteger1 const &)     { return false; }
	inline bool fbxCopy( fbxUByte1 &,fbxLongLong1 const &)     { return false; }
	inline bool fbxCopy( fbxUByte1 &,fbxULongLong1 const &)    { return false; }
	inline bool fbxCopy( fbxUByte1 &,fbxHalfFloat const &)     { return false; }
    ...
    inline bool fbxCopy( fbxUByte1 &,fbxDouble2 const & )		{ return false; }
	inline bool fbxCopy( fbxUByte1 &,fbxDouble3 const & )		{ return false; }
    inline bool fbxCopy( fbxUByte1 &,fbxDouble4 const & )		{ return false; }
    inline bool fbxCopy( fbxUByte1 &,fbxDouble44 const & )      { return false; }
//  inline bool fbxCopy( fbxUByte1 &pDst,fbxEnum const &pSrc )          { return false; }
    ...
    inline bool fbxCopy( fbxUByte1 &,fbxTime const & )          { return false; }
    inline bool fbxCopy( fbxUByte1 &,fbxReference const & )     { return false; }
