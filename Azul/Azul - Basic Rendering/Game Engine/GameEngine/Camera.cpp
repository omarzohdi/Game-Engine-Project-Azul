...
void Camera::getFrontNorm( Vect &outNorm )
{
	outNorm = this->frontNorm;
}
void Camera::getBackNorm( Vect &outNorm )
{
	outNorm = this->backNorm;
}
void Camera::getRightNorm( Vect &outNorm )
{
	outNorm = this->rightNorm;
}
void Camera::getLeftNorm( Vect &outNorm )
{
	outNorm = this->leftNorm;
}
void Camera::getTopNorm( Vect &outNorm )
{
	outNorm = this->topNorm;
}
void Camera::getBottomNorm( Vect &outNorm )
{
	outNorm = this->bottomNorm;
}

void Camera::getNearBottomLeft( Vect &outNBL )
{
	outNBL = this->nearBottomLeft;
}
void Camera::getFarTopRight( Vect &outFTR )
{
	outFTR = this->farTopRight;
}
